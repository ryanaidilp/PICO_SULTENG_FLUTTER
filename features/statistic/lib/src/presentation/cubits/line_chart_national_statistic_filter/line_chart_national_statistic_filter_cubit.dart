...
part 'line_chart_national_statistic_filter_state.dart';

class LineChartNationalStatisticFilter
    extends Cubit<LineChartNationalStatisticState> {
  LineChartNationalStatisticFilter() : super(LineChartNationalStatisticState());
